# Robotic Arm (Arduino project) assembly guide
...
Complete Robotics arm.
Controlled through an arduino.

Tags: motor, robot, arm, robotics, robotarm, roboticsproject

## Repository contents

- `bom.csv` - bill of materials exported from the Maker Portal (0 rows at generation time).
