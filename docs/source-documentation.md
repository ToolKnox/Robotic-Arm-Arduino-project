...
- AliExpress links are tracked `s.click.aliexpress.com` product links generated through the AliExpress affiliate API. Earlier search fallback links were replaced after the adapter was corrected to use the signed Open Platform `/sync` API.
